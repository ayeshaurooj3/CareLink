    ...
    <header class="container-fluid py-4">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="tel:+1234567890" class="text-black"><i class="bi bi-telephone"></i> +92 333 7626116</a>
            ...
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="h1 text-primary mb-0">Care<span class="text-white">Link</span></h1>
                    </a>
                    <p class="fs-5 mb-4">Your health is our priority. We provide a range of healthcare services to meet your needs.</p>
